  ...
  return (
    <div>
      ...
      <div className="relative overflow-hidden">
        ...
        {/* Welcome Message */}
        <section className="relative flex flex-col items-center justify-center h-screen text-center bg-gray-800 bg-opacity-60 text-white px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4">Welcome to Our Car Rental Service</h1>
            <p className="text-base sm:text-lg md:text-xl mb-6">Find the perfect car for your next adventure.</p>
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-8">Ready to Rent Your Dream Car?</h2>
