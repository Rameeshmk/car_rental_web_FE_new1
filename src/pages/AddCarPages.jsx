  ...
  return (
    <div className="flex flex-col h-screen bg-cover bg-center"
      ...
      <div className="flex h-screen items-center justify-center bg-black bg-opacity-50">
        <div className="relative w-4/5 md:w-1/2 lg:w-1/3">
          <button
            onClick={() => navigate(-1)} // Go back to the previous page
            className="absolute top-4 left-4 rounded-md bg-blue-500 py-2 px-4 text-white cursor-pointer hover:bg-blue-600 transition-colors"
          >
            Go Back
          </button>
          <form
            onSubmit={handleSubmit(onSubmit)}
            className="flex flex-col gap-y-4 rounded-lg border p-6 bg-white shadow-lg"
          >
